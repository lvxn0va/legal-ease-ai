...
def test_summary_generation():
    ...
    sample_nlp_data = {
        "parties": {"landlord": "1722 J ST, LLC", "tenant": "ABBY A KARAVANI"},
        "dates": {
            "effectiveDate": "February 1, 2020",
            "expirationDate": "January 31, 2025",
        },
        "rent": {"baseRent": "$3,500.00"},
        "options": {"renewalOptions": ["Standard renewal terms apply"]},
    ...
    all_tests_passed = (
        ...
        and validation_result["quality_score"] > 0.3
